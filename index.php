...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['snoEdit'])){
        ...
        $sql = "UPDATE `notes` SET `note` = '$note',  `details` = '$details'  WHERE `notes`.`sno` = '$sno'"; 
        $result = mysqli_query($conn, $sql);
        if($result){
            $update = true;
        }
    ...
    $sql = "INSERT INTO `notes` (`note`, `details`) VALUES ('$note', '$details')";
    $result = mysqli_query($conn, $sql);
}}
?>
...
<html lang="en">
  <head>
   ...
   <!-- insert cdn jquery  -->
    ...
    <!-- get this from datatables datatables j query -->
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  ...
  <div class="mb-3">
    ...
    <textarea type="text" class="form-control" id="detailsEdit" name="detailsEdit" cols="5" rows="5"></textarea>
  </div>
</div>
<div class="modal-footer d-block mr">
...
<form action="/php/index.php" method="post"> 
  ...
  <div class="mb-3">
    <label for="details" class="form-label">Details</label>
    <textarea type="text" class="form-control" id="details" name="details" cols="5" rows="5"></textarea>
  </div>
